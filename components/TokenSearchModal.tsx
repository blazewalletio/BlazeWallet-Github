...
export default function TokenSearchModal({
  ...
  const fetchTokens = async () => {
    ...
    try {
      // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      // STRATEGY A: onlyShowTokensWithBalance=true (FROM token selection)
      // Show ONLY tokens user has in wallet
      // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      if (onlyShowTokensWithBalance && walletTokens.length > 0) {
        ...
        logger.log(`✅ [TokenSearchModal] Loaded ${walletTokensList.length} wallet tokens for ${chainKey}`);
        setIsLoading(false);
        return;
      }
      
      // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      // STRATEGY B: onlyShowTokensWithBalance=false (TO token selection)
      // Use CURATED popular tokens (INSTANT load!) + Li.Fi search
      // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      logger.log(`⚡ [TokenSearchModal] Using CURATED popular tokens for ${chainKey}...`);
      ...
      logger.error('❌ [TokenSearchModal] Error fetching tokens:', error);
