            ...
            {mode === 'method' && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full p-6 rounded-xl bg-white border-2 border-gray-200 hover:border-green-400 hover:shadow-lg transition-all group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-bold text-gray-900 text-lg">Scan QR Code</span>
                          <span className="px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-xs font-semibold">
                            Fastest
                          </span>
                        </div>
                        <div className="text-sm text-gray-600">Scan merchant payment QR</div>
                  ...
                  <motion.button
                    ...
                    className="w-full p-6 rounded-xl bg-white border-2 border-gray-200 hover:border-orange-400 hover:shadow-lg transition-all group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-bold text-gray-900 text-lg">Send to address</span>
                          <span className="px-2 py-0.5 rounded-full bg-orange-100 text-orange-700 text-xs font-semibold">
                            Most flexible
                          </span>
                        </div>
                        <div className="text-sm text-gray-600">Enter amount & wallet address</div>
                  ...
                  <motion.button
                    ...
                    className="w-full p-6 rounded-xl bg-white border-2 border-gray-200 hover:border-purple-400 hover:shadow-lg transition-all group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-bold text-gray-900 text-lg">Lightning payment</span>
                          <span className="px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 text-xs font-semibold">
                            Zero fees
                          </span>
                        </div>
                        <div className="text-sm text-gray-600">Generate Lightning invoice</div>
                        <div className="text-xs text-gray-500 mt-1">→ Receive crypto</div>
                      </div>
