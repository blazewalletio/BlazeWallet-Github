      ...
      >
        <div className="max-w-2xl mx-auto p-6 pb-32">
          ...
          <motion.div
            ...
            className="glass-card rounded-2xl p-6 mb-6 border border-gray-200"
          >
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3 px-1">PROFILE</h3>
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3 px-1">SECURITY</h3>
            <div className="glass-card rounded-2xl border border-gray-200 overflow-hidden">
              <button className="w-full flex items-center gap-4 p-4 hover:bg-gray-50 transition-colors border-b border-gray-100">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3 px-1">PREFERENCES</h3>
            <div className="glass-card rounded-2xl border border-gray-200 overflow-hidden">
              <button 
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3 px-1">ADVANCED</h3>
            <div className="glass-card rounded-2xl border border-gray-200 overflow-hidden">
              <button 
                onClick={() => {
                  onClose();
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button 
                ...
                className="glass-card rounded-xl p-6 border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all group"
              >
              ...
              <button 
                ...
                className="glass-card rounded-xl p-6 border border-gray-200 hover:border-red-300 hover:bg-red-50 transition-all group"
              >
