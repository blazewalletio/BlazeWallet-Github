...
CREATE TABLE IF NOT EXISTS public.favorite_tokens (
  ...
  token_address VARCHAR(255) NOT NULL, -- Contract address (or 'native' for native tokens)
...
CREATE INDEX idx_favorite_tokens_address ON public.favorite_tokens(token_address);
