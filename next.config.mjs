...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      font-src 'self';
      connect-src 'self' https://ldehmephukevxumwdbwt.supabase.co https://api.openai.com https://api.coingecko.com https://*.etherscan.io https://*.bscscan.com https://*.polygonscan.com https://*.arbiscan.io https://*.optimistic.etherscan.io https://*.basescan.org https://*.snowtrace.io https://*.ftmscan.com https://*.cronoscan.com https://*.lineascan.build https://*.blockchair.com https://*.blockchain.com https://*.blockstream.info https://blockstream.info https://mempool.space https://api.blockcypher.com https://blockchain.info https://global.transak.com https://*.alchemy.com https://*.infura.io https://*.quicknode.pro https://api.dexscreener.com https://price.jup.ag https://api.binance.com https://api.coingecko.com wss://ldehmephukevxumwdbwt.supabase.co;
