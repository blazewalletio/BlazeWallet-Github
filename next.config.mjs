...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      font-src 'self';
      connect-src 'self' https://ldehmephukevxumwdbwt.supabase.co https://api.openai.com https://api.coingecko.com https://api.exchangerate-api.com https://*.etherscan.io https://*.bscscan.com https://*.polygonscan.com https://*.arbiscan.io https://*.optimistic.etherscan.io https://*.basescan.org https://*.snowtrace.io https://*.ftmscan.com https://*.cronoscan.com https://*.lineascan.build https://*.blockchair.com https://*.blockchain.com https://*.blockstream.info https://blockstream.info https://mempool.space https://api.blockcypher.com https://blockchain.info https://global.transak.com https://*.alchemy.com https://*.infura.io https://*.quicknode.pro https://api.dexscreener.com https://cdn.dexscreener.com https://ipfs.io https://price.jup.ag https://api.binance.com https://bsc-dataseed.binance.org https://bsc-dataseed1.binance.org https://bsc-dataseed2.binance.org https://bsc-dataseed3.binance.org https://bsc-dataseed4.binance.org https://data-seed-prebsc-1-s1.binance.org:8545 https://rpc.ankr.com https://mainnet.optimism.io https://api.avax.network https://polygon-rpc.com https://evm.cronos.org https://rpc.linea.build https://arb1.arbitrum.io https://mainnet.base.org https://*.publicnode.com https://rpcapi.fantom.network https://mainnet.era.zksync.io https://*.explorer.zksync.io https://*.era.zksync.io wss://ldehmephukevxumwdbwt.supabase.co;
